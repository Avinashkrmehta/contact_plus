...
ActiveRecord::Schema.define(version: 2020_01_29_024905) do
  ...
  create_table "panchayats", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["block_id"], name: "index_panchayats_on_block_id"
  end
  ...
  create_table "villages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["panchayat_id"], name: "index_villages_on_panchayat_id"
  end
