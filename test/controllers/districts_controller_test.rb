...
class DistrictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create district" do
    assert_difference('District.count') do
      post districts_url, params: { district: { code: @district.code, name: @district.name } }, as: :json
    end
  ...
  test "should update district" do
    patch district_url(@district), params: { district: { code: @district.code, name: @district.name } }, as: :json
    assert_response 200
  end
